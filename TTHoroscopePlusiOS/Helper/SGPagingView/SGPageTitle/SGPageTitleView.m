...
- (void)setupSubviews {
    ...
    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(0, SGPageTitleViewHeight-self.configure.indicatorHeight, self.scrollView.contentSize.width, self.configure.indicatorHeight)];
    lineView.backgroundColor = [UIColor whiteColor]; //[UIColor colorWithHex:0x666666];
    [self.scrollView insertSubview:lineView atIndex:0];
}
...
- (void)P_changeSelectedButton:(UIButton *)button {
    ...
    if (self.configure.titleSelectedFont == kFontTitle_L_15/*[UIFont systemFontOfSize:15]*/) {
