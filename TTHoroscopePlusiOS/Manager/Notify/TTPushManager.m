...
#import "TTPushManager_Extension.h"
#import <FCUUID/FCUUID.h>
#import "TTRequestTool.h"
@interface TTPushManager()<UNUserNotificationCenterDelegate>
...
+ (void)registerDeviceToken:(NSData *)deviceToken{
    ...
    [TTRequestTool requestWithURLType:DeviceToken params:param1.mutableCopy success:^(NSDictionary *dictData) {
        NSLog(@"上报Device成功:\n%@", dictData)
        //af6e5291ef56292989abfcf484322e25e994bf7189f87a3addf6a50e883b8850
...
static TTPushManager *shared = nil;
+ (TTPushManager *)shared
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared = [[TTPushManager alloc] init];
    });
    return shared;
}
