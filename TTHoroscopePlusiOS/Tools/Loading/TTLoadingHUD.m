...
#define instance [TTLoadingHUD shareInstance]


@interface TTLoadingHUD ()
...
@implementation TTLoadingHUD

+ (instancetype) shareInstance{
    static TTLoadingHUD* _instance = nil;
...
+(void)show{
    if (!instance.isShow) {
        instance.isShow = YES;
        UIView *view = [self CreateLoadingViewWithFrame:CGRectMake(0, 0, KScreenWidth, KScreenHeight)];
...
//    view.backgroundColor = [UIColor whiteColor];
    ...
    TTLoadingView *loadingV = [[TTLoadingView alloc]initWithFrame:CGRectMake(0, 0, hudWidth, hudWidth)];
...
- (UIView *)loadingViewMethod{
    UIView *baseView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, KScreenWidth, KScreenHeight)];
    baseView.backgroundColor = [[UIColor blackColor]colorWithAlphaComponent:0.5];
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, whiteWidth, whiteWidth)];
    [baseView addSubview:view];
    view.layer.masksToBounds = YES;
    view.layer.cornerRadius = whiteWidth*0.5;
    view.center = CGPointMake(KScreenWidth*0.5, KScreenHeight*0.5);
//    view.backgroundColor = [UIColor whiteColor];
